...
class MIDI_Mix(APC, OptimizedControlSurface):
    ...
    def _create_session(self):
        ...
        self._session = SessionComponent(num_tracks=NUM_TRACKS, num_scenes=NUM_SCENES, is_enabled=True, auto_name=True, enable_skinning=True)
        self._session.set_offsets(0, 0)
        self._session.layer = Layer(track_bank_left_button=self._bank_left_button, track_bank_right_button=self._bank_right_button)
